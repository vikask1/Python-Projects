...
answers_choice = [
    ...
    ["40 years","45 years","60 years","76 years",],
    ["Ampere","Volt","Coulomb","Watt",],
    ["Sep 8","Nov 28","May 2","Sep 22",],
    ["Patna","Delhi","Benaras","Agra",],
    ["Vishing","Fhishing","Phishing","Jacking",],
    ["Bengaluru","Kochin","Mumbai","Vishakhapatnam",],
    ["Heat is converted into electrical energy","Electrical energy is converted into heat","Electrical energy is converted into mechanical energy","Mechanical energy is converted into electrical energy",],
    ["Pure water"," Neutral Solution","Basic Solution","Acidic Solution",],
    ["Dots per Inch","Strike per Inch"," Words per Inch"," Alphabet per strike",],
    ["Rich Lesser","Muhtar Kent","Anant Maheshwari","Sundar Pichai",],
    ["Jaipur","Chennai","Hyderabad","Pune",],
    ["Acetylsalicylic acid","Sodium bicarbonate","Potassium aluminium sulphate","Ethyl alcohol",],
    ["1500","2000","2500","3000",],
] 
